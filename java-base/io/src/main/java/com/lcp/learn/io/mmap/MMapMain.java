 ...
 *
 * @author lichunpeng
 * @since 2021/4/20-09:46
 */
public class MMapMain {

  public static String path = "/Users/lichunpeng/tmp/";

  public static void main(String[] args) throws IOException {
    File file1 = new File(path, "haha2");
