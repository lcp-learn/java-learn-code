...
public class MyBeanPostProcessor implements BeanPostProcessor {
  ...
  public Object postProcessBeforeInitialization(Object bean, String beanName) throws BeansException {
    if (bean instanceof AService) {
      logger.info("bean 对象初始化之前.beanName:{},bean:{}", beanName, bean.getClass().getName());
    }
    return bean;
    // return bean对象监控代理对象
  }
  ...
  public Object postProcessAfterInitialization(final Object bean, String beanName) throws BeansException {
    ...
    if (bean instanceof AService) {
      ...
      return Proxy.newProxyInstance(bean.getClass().getClassLoader(), bean.getClass().getInterfaces(),
          (proxy1, method, args) -> {
            logger.info("AService 中的 doSome() 被拦截了···bean:{}", bean.getClass().getName());
            Object result = method.invoke(bean, args);
            logger.info("result:{}", (String) result);
            return (String) result + "->p1";
